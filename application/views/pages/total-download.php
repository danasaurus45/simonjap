            ...
            <div class="col-12">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Download File Jumlah Penduduk</h3>
                    </div>
                    <!-- /.card-header -->
                    <form action="<?php echo base_url('total/spreadsheet_download') ?>" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="<?php echo base_url('total') ?>" class="btn btn-warning">Kembali</a>
                        </div>
                    </form>
                </div>
                <!-- /.card -->
